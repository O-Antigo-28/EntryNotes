...
import { INoteCaixaWithPixToday } from "./INoteCaixaToday";
export class CaixaNoteExtractorWithPix extends NoteExtractor{

    public extractNotes(_table: Object[]): void {
      const APPROVED_SALE = "AUTORIZADA" 

  
      _table.forEach((object: INoteCaixaWithPixToday) => {
        console.log(object.Parcelado)
        console.log(object.Modalidade)
          const paymentMethod: PaymentMethod = this._extractPaymentMethod(object.Modalidade, object.Parcelado)
