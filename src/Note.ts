export type PaymentMethod = PAYMENT_METHODS.DEBIT | PAYMENT_METHODS.INSTALLMENT | PAYMENT_METHODS.CREDIT | PAYMENT_METHODS.TICKET | PAYMENT_METHODS.NONEXISTENT | PAYMENT_METHODS.CASH_CREDIT
