...
async function CreateTablesOfDBLabelsIfNotExists(pool: Pool){
    ...
    try{
        ...
        client.query("CREATE TABLE IF NOT EXISTS PRICE(PRICE_ID SERIAL PRIMARY KEY NOT NULL, PRICE_VALUE DECIMAL NOT NULL ,PRICE_DATE DATE, TAG_ID VARCHAR(150) NOT NULL, FOREIGN KEY (TAG_ID) REFERENCES TAG(BARCODE) ON DELETE CASCADE);")
        client.query(`
